                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-responsive-md">
                                        ...
                                        <tbody>
                                            <?php
                                            $fetch = mysqli_query($con, "SELECT * FROM users WHERE role='apply'");
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <a href="php/apply_accept.php?id=<?php echo $row['id']; ?>&role=volunteer" class="btn btn-success btn-sm p-0" title="Approve"><i class="bi bi-check" style="font-size: 30px;"></i></a>
