                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit member ( <b><?php echo $data['user_name']; ?></b> ) </h4>
                        </div>
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="php/user_edit.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="member's names" name="name" value="<?php echo $data['user_name']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="email" class="form-control" placeholder="member's email" name="email" value="<?php echo $data['email']; ?>" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="member's role" name="role" value="<?php echo $data['role']; ?>" required>
                                        </div>
                                    </div>
                                    <fieldset class="mb-3">
                                        <div class="row">
                                    ...
                                    <div class="mb-3 row">
                                        <button type="submit" name="add" class="btn btn-primary">Update member</button>
                                    </div>
                                </form>
                            </div>
                        </div>
